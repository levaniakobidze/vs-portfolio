...
function Navbar() {
  const { activeNav, changeActiveNav,showMenu,onShowMobileMenu } = useContext(AppContext);
    ...
    <nav className={classes.navbar}>
      <Container className={classes.navbar_container}>
        ...
        <div className={classes.left}>
          <ul className={!showMenu ? classes.navbar_menu : `${classes.navbar_menu} ${classes.navbar_menu_active}`}>
